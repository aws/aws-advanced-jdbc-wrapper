...
dependencies {
    ...
    implementation("software.amazon.awssdk:rds:2.32.22")
    implementation("software.amazon.awssdk:secretsmanager:2.32.22")
    implementation("software.amazon.awssdk:sts:2.32.22")
