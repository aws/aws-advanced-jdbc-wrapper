...
dependencies {
    ...
    implementation("software.amazon.awssdk:rds:2.46.3")
    implementation("software.amazon.awssdk:secretsmanager:2.46.3")
    implementation("software.amazon.awssdk:sts:2.46.3")
