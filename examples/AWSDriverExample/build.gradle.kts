...
dependencies {
    ...
    implementation("software.amazon.awssdk:rds:2.42.19")
    implementation("software.amazon.awssdk:secretsmanager:2.42.19")
    implementation("software.amazon.awssdk:sts:2.42.19")
