...
dependencies {
    ...
    implementation("software.amazon.awssdk:rds:2.25.36")
    implementation("software.amazon.awssdk:secretsmanager:2.25.40")
    implementation("software.amazon.awssdk:sts:2.25.36")
    ...
    implementation("com.amazonaws:aws-xray-recorder-sdk-core:2.15.2")
