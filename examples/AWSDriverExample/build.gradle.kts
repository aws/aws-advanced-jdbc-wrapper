...
dependencies {
    ...
    implementation("software.amazon.awssdk:rds:2.41.30")
    implementation("software.amazon.awssdk:secretsmanager:2.41.30")
    implementation("software.amazon.awssdk:sts:2.41.30")
