...
The JDBC Driver has several built-in plugins; you can [see the list here](../using-the-jdbc-wrapper/UsingTheJdbcWrapper.md#list-of-available-plugins).
...
2. Using driver-specific properties or objects:
   - the JDBC Driver may be used with multiple drivers, therefore plugins must ensure implementation is not restricted to a specific driver
