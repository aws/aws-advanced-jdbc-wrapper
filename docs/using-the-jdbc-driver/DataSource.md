...
| URL name                    | `setUrlPropertyName`           | The name of the URL property.                                                                     | `String` | No, but some drivers, such as MariaDb, require some parameters to be included in url so we recommend to provide this parameter. | `url`                                  |
