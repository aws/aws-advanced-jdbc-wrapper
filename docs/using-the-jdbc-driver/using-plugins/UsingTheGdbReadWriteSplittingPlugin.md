...
> [!NOTE]
> For an in-depth explanation of `gdbAccessibleRegions`, see [Restricting Aurora Global Database Access by Region](./UsingGlobalAuroraAccessibleRegions.md). The topology monitor used by this plugin also honors [`gdbMonitoringConnectionPriority`](./UsingMonitoringConnectionPriority.md).

| Parameter                         |  Value  |                                                                  Required                                                                   | Description                                                                                                                                                                                                                                                                                                                                                                                            | Default Value                                                                                                                    |
|-----------------------------------|:-------:|:-------------------------------------------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|
| `readerHostSelectorStrategy`      | String  |                                                                     No                                                                      | The name of the strategy that should be used to select a new reader host. For more information on the available reader selection strategies, see this [table](../HostSelectionStrategies.md).                                                                                                                                                                                                          | `random`                                                                                                                         |
...
| `gdbRwRestrictWriterToHomeRegion` | Boolean |                                                                     No                                                                      | If set to `true`, prevents following and connecting to a writer node outside the defined home region. An exception will be raised when such a connection to a writer outside the home region is requested.                                                                                                                                                                                             | `true`                                                                                                                           |
...
| `gdbEnableGlobalWriteForwarding`  | Boolean |                                                                     No                                                                      | If set to `true`, allows connections in the secondary region to forward write queries to the primary global region. This is useful if your home region is the secondary global region. This functionality requires [Global Write Forwarding](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-global-database-write-forwarding.html) to be enabled.                                                                                                                                                                                                                                    | `false`                                                                                                                          |
| `gdbAccessibleRegions`            | String  |                                                                     No                                                                      | Available since version 4.1.0.<br><br>Comma-separated list of AWS regions accessible by the application. When set, read/write splitting will only consider nodes in the specified regions. Writer connections to nodes in non-accessible regions will be rejected with an error. Reader host candidates will be filtered to only include nodes in accessible regions. This is useful when the application has network restrictions and cannot reach certain AWS regions.<br><br>If `gdbRwHomeRegion` is also specified, the home region must be included in the accessible regions list; otherwise, an error will be raised at initialization.<br><br>Example: `us-east-1,us-west-2`                                                                                                                                                    | `null` (no restriction, all regions are accessible)                                                                              |
