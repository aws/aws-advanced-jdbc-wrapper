...
| `gdbRwRestrictWriterToHomeRegion` | Boolean |                                                                     No                                                                      | If set to `true`, prevents following and connecting to a writer node outside the defined home region. An exception will be raised when such a connection to a writer outside the home region is requested.                                                                                                                                                                                             | `false`                                                                                                                          |
| `gdbRwRestrictReaderToHomeRegion` | Boolean |                                                                     No                                                                      | If set to `true`, prevents connecting to a reader node outside the defined home region. If no reader nodes in the home region are available, an exception will be raised.                                                                                                                                                                                                                              | `false`                                                                                                                          |
