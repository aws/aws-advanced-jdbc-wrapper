...
| `sslMode`         | String  |    No    | This property is required when using the IAM Authentication plugin with the MariaDB driver.                                                                                                                                                                                                                            | `verify-ca`                                         |
| `serverSslCert`   | String  |    No    | This property is required when using the IAM Authentication plugin with the MariaDB driver. The value of this property should be the path to a SSL certificate. The certificates can be found [here](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/UsingWithRDS.SSL.html).                                    | `path/to/certificate.pem`                           |
