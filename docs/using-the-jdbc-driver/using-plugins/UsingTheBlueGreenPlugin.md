...
| ~~`bgSuspendNewBlueConnections`~~ | Boolean |                              No                              | **Deprecated. Adding this parameter causes no changes in plugin behaviour.** <br/><br/>Enables Blue/Green Deployment switchover to suspend new blue connection requests while the switchover process is in progress.                                                                                                                                                                                                                                    | `false`                  | `false`       |
