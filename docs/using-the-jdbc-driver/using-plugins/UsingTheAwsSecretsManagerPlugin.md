...
| `secretsManagerExpirationTimeSec`      | 3.1.0 | Integer |                            No                            | This property sets the time in seconds that secrets are cached before it is re-fetched.                                                                                                                                          | `600`                   | `870`         |
...
| `secretsManagerConnectRetryTimeoutMs`  | 4.4.0 | Long    |                            No                            | Total time budget, in milliseconds, for retrying a connection that failed to log in, re-fetching the credentials before each retry. `0` disables retrying. See [Bridging a credential rotation window](#bridging-a-credential-rotation-window). | `90000`                 | `0`           |
