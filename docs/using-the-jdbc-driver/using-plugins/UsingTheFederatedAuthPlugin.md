...
It is important to note that the Uber JAR is bundled with the AWS Java RDS SDK and is larger (**15 MB**) than our `aws-advanced-jdbc-wrapper-4.0.0.jar`. So please take that into account when deciding if this solution is for you.
