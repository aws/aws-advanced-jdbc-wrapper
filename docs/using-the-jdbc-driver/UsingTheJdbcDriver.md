...
| [Developer Plugin](./using-plugins/UsingTheDeveloperPlugin.md)                                 | `dev`                     | Any database           | Helps development team to test various every day scenarios including rare events like network outages and database cluster failover. The plugin allows to inject and then raise an expected exception and verify how application handles it.                                                                                                                                                                                                                                                                           |
