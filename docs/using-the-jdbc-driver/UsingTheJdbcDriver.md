...
| `awsProfile`                    | `String`  | No       | Allows to specify a profile name for AWS credentials. This parameter is used by some of plugins, like [IAM Authentication Connection Plugin](./using-plugins/UsingTheIamAuthenticationPlugin.md) and [AWS Secrets Manager Connection Plugin](./using-plugins/UsingTheAwsSecretsManagerPlugin.md), that require AWS credentials. | `null`        |
