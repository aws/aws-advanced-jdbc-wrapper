...
| [Read Only Endpoint Connection Plugin](./using-plugins/UsingTheReadOnlyEndpointConnectionPlugin.md) | `readOnlyEndpoint`        | Aurora                          | When connections are made to the read only endpoint of Aurora databases, this plugin will swap the cluster connection with an instance connection. This can be used in specific scenarios where operations rely on having a consistent connection to an instance.                                                                                                                                                                                                                                                      | None                                                                                                                                                                                                          |
