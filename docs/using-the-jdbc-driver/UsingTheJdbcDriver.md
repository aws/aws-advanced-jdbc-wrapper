...
| [Custom Endpoint Plugin](./using-plugins/UsingTheCustomEndpointPlugin.md)                                         | `customEndpoint`          | Aurora, <br>RDS Instance                                                       | Enables custom endpoint support.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | [AWS Java SDK RDS v2.7.x or later](https://central.sonatype.com/artifact/software.amazon.awssdk/rds) and [valid AWS credentials](./AwsCredentials.md)                                                                                                                                                                                                                    | 2.5.0                   |
