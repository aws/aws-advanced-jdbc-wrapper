...
| [AWS Secrets Manager Connection Plugin v2](./using-plugins/UsingTheAwsSecretsManagerPlugin2.md)                   | `awsSecretsManager2`      | Any database                                                                   | Enables fetching database credentials from the AWS Secrets Manager service using a Stale-While-Revalidate (SWR) caching strategy. Connections proceed immediately using cached credentials (even if stale), while a background async task refreshes the cache. This eliminates connection latency spikes during credential rotation and improves resilience during temporary Secrets Manager outages.                                                                                                                                                                                                                                                             | [Jackson Databind](https://central.sonatype.com/artifact/com.fasterxml.jackson.core/jackson-databind)<br>[AWS Secrets Manager](https://central.sonatype.com/artifact/software.amazon.awssdk/secretsmanager) and [valid AWS credentials](./AwsCredentials.md)                                                                                                             | 3.3.0                   |
