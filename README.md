...
### Using the AWS JDBC Driver with AWS Aurora DSQL
The AWS JDBC Driver is able to handle IAM authentication when working with AWS Aurora DSQL clusters.

Please visit [this page](./docs/using-the-jdbc-driver/using-plugins/UsingTheDsqlAuthenticationPlugin.md) for more information.
