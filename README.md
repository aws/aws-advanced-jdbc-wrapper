...
| `awsProfile`                           |                                        `PropertyDefinition.AWS_PROFILE`                                        | [AWS Advanced JDBC Wrapper Parameters](./docs/using-the-jdbc-driver/UsingTheJdbcDriver.md#aws-advanced-jdbc-driver-parameters) |
| `wrapperLogUnclosedConnections`        |                                 `PropertyDefinition.LOG_UNCLOSED_CONNECTIONS`                                  | [AWS Advanced JDBC Wrapper Parameters](./docs/using-the-jdbc-driver/UsingTheJdbcDriver.md#aws-advanced-jdbc-driver-parameters) |
...
| `loginTimeout`                         |                                       `PropertyDefinition.LOGIN_TIMEOUT`                                       | [AWS Advanced JDBC Wrapper Parameters](./docs/using-the-jdbc-driver/UsingTheJdbcDriver.md#aws-advanced-jdbc-driver-parameters) |
| `connectTimeout`                       |                                      `PropertyDefinition.CONNECT_TIMEOUT`                                      | [AWS Advanced JDBC Wrapper Parameters](./docs/using-the-jdbc-driver/UsingTheJdbcDriver.md#aws-advanced-jdbc-driver-parameters) |
| `socketTimeout`                        |                                      `PropertyDefinition.SOCKET_TIMEOUT`                                       | [AWS Advanced JDBC Wrapper Parameters](./docs/using-the-jdbc-driver/UsingTheJdbcDriver.md#aws-advanced-jdbc-driver-parameters) |
| `tcpKeepAlive`                         |                                      `PropertyDefinition.TCP_KEEP_ALIVE`                                       | [AWS Advanced JDBC Wrapper Parameters](./docs/using-the-jdbc-driver/UsingTheJdbcDriver.md#aws-advanced-jdbc-driver-parameters) |
