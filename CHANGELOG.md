...
- The Enhanced Host Monitoring Plugin (EFM) v2 is now a default plugin. The original EFM plugin can still be used if specified using the `wrapperPlugins property ([PR #825](https://github.com/awslabs/aws-advanced-jdbc-wrapper/pull/825)). 
