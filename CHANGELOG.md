...
### :magic_wand: Added
- Added KMS Encryption Plugin for encrypting/decrypting database credentials using AWS KMS ([PR #1772](https://github.com/aws/aws-advanced-jdbc-wrapper/pull/1772)).
