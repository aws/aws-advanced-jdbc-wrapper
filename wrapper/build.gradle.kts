...
dependencies {
    ...
    optionalImplementation("software.amazon.awssdk:rds:2.46.5")
    optionalImplementation("software.amazon.awssdk:auth:2.46.5") // Required for IAM (light implementation)
    optionalImplementation("software.amazon.awssdk:http-client-spi:2.46.5") // Required for IAM (light implementation)
    optionalImplementation("software.amazon.awssdk:sts:2.46.5")
    optionalImplementation("software.amazon.awssdk:kms:2.46.5")
    optionalImplementation("software.amazon.awssdk:secretsmanager:2.46.5")
    ...
    optionalImplementation("io.opentelemetry:opentelemetry-api:1.62.0")
    ...
    federatedAuthBundleImplementation("software.amazon.awssdk:rds:2.46.5")
    federatedAuthBundleImplementation("software.amazon.awssdk:sts:2.46.5")
    ...
    testImplementation("software.amazon.awssdk:kms:2.46.5")
    testImplementation("software.amazon.awssdk:rds:2.46.5", )
    testImplementation("software.amazon.awssdk:auth:2.46.5") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:http-client-spi:2.46.5") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:ec2:2.46.5")
    testImplementation("software.amazon.awssdk:secretsmanager:2.46.5")
    testImplementation("software.amazon.awssdk:sts:2.46.5")
    ...
    testImplementation("tools.jackson.core:jackson-databind:3.1.3") // Required for java17 multi-release classes under Java 17+
    ...
    testImplementation("io.opentelemetry:opentelemetry-sdk-metrics:1.62.0")
    testImplementation("io.opentelemetry:opentelemetry-exporter-otlp:1.62.0")
...
dependencies {
    ...
    add(hibernateTest.implementationConfigurationName, "org.hibernate:hibernate-core:7.4.1.Final")
