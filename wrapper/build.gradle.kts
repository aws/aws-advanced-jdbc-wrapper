...
dependencies {
    ...
    optionalImplementation("software.amazon.awssdk:rds:2.43.0")
    optionalImplementation("software.amazon.awssdk:auth:2.43.0") // Required for IAM (light implementation)
    ...
    testImplementation("software.amazon.awssdk:kms:2.43.0")
    testImplementation("software.amazon.awssdk:rds:2.43.0", )
    testImplementation("software.amazon.awssdk:auth:2.43.0") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:http-client-spi:2.43.0") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:ec2:2.43.0")
    testImplementation("software.amazon.awssdk:secretsmanager:2.43.0")
    testImplementation("software.amazon.awssdk:sts:2.43.0")
