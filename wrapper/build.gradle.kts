...
dependencies {
    ...
    compileOnly("com.zaxxer:HikariCP:5.0.1") // Version 4.+ is compatible with Java 8
    ...
    testImplementation("com.zaxxer:HikariCP:5.0.1") // Version 4.+ is compatible with Java 8
