...
dependencies {
    ...
    compileOnly("software.amazon.awssdk:auth:2.27.8") // Required for IAM (light implementation)
    ...
    testImplementation("software.amazon.awssdk:auth:2.27.8") // Required for IAM (light implementation)
