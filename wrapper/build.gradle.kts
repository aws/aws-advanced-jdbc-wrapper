...
dependencies {
    ...
    compileOnly("software.amazon.awssdk:rds:2.31.77")
    ...
    compileOnly("software.amazon.awssdk:sts:2.31.77")
    ...
    testImplementation("software.amazon.awssdk:rds:2.31.77")
    ...
    testImplementation("software.amazon.awssdk:sts:2.31.77")
