...
dependencies {
    ...
    optionalImplementation("software.amazon.awssdk:rds:2.42.37")
    optionalImplementation("software.amazon.awssdk:auth:2.42.37") // Required for IAM (light implementation)
    optionalImplementation("software.amazon.awssdk:http-client-spi:2.42.37") // Required for IAM (light implementation)
    optionalImplementation("software.amazon.awssdk:sts:2.42.37")
    optionalImplementation("software.amazon.awssdk:kms:2.42.37")
    optionalImplementation("software.amazon.awssdk:secretsmanager:2.42.37")
    ...
    optionalImplementation("io.opentelemetry:opentelemetry-sdk-metrics:1.61.0")
    ...
    federatedAuthBundleImplementation("software.amazon.awssdk:rds:2.42.37")
    federatedAuthBundleImplementation("software.amazon.awssdk:sts:2.42.37")
    ...
    testImplementation("software.amazon.awssdk:kms:2.42.37")
    testImplementation("software.amazon.awssdk:rds:2.42.37", )
    testImplementation("software.amazon.awssdk:auth:2.42.37") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:http-client-spi:2.42.37") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:ec2:2.42.37")
    testImplementation("software.amazon.awssdk:secretsmanager:2.42.37")
    testImplementation("software.amazon.awssdk:sts:2.42.37")
    ...
    testImplementation("tools.jackson.core:jackson-databind:3.1.2") // Required for java17 multi-release classes under Java 17+
...
dependencies {
    ...
    add(java17.implementationConfigurationName, "tools.jackson.core:jackson-databind:3.1.2")
