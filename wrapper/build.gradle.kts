...
dependencies {
    ...
    compileOnly("software.amazon.awssdk:auth:2.30.32") // Required for IAM (light implementation)
    ...
    testImplementation("software.amazon.awssdk:auth:2.30.32") // Required for IAM (light implementation)
