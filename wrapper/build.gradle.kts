...
dependencies {
    ...
    optionalImplementation("software.amazon.awssdk:rds:2.41.30")
    optionalImplementation("software.amazon.awssdk:auth:2.41.30") // Required for IAM (light implementation)
    optionalImplementation("software.amazon.awssdk:http-client-spi:2.41.30") // Required for IAM (light implementation)
    optionalImplementation("software.amazon.awssdk:sts:2.41.30")
    optionalImplementation("software.amazon.awssdk:secretsmanager:2.41.30")
    ...
    federatedAuthBundleImplementation("software.amazon.awssdk:rds:2.41.30")
    federatedAuthBundleImplementation("software.amazon.awssdk:sts:2.41.30")
    ...
    testImplementation("software.amazon.awssdk:rds:2.41.30", )
    testImplementation("software.amazon.awssdk:auth:2.41.30") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:http-client-spi:2.41.30") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:ec2:2.41.30")
    testImplementation("software.amazon.awssdk:secretsmanager:2.41.30")
    testImplementation("software.amazon.awssdk:sts:2.41.30")
