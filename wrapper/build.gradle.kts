...
dependencies {
    ...
    compileOnly("software.amazon.awssdk:http-client-spi:2.31.78") // Required for IAM (light implementation)
    ...
    testImplementation("software.amazon.awssdk:rds:2.31.50")
    testImplementation("software.amazon.awssdk:auth:2.31.45") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:http-client-spi:2.31.78") // Required for IAM (light implementation)
