...
dependencies {
    ...
    optionalImplementation("org.jsoup:jsoup:1.23.1")
    ...
    federatedAuthBundleImplementation("org.jsoup:jsoup:1.23.1")
    ...
    testImplementation("org.jboss.narayana.jta:narayana-jta:5.13.1.Final") // 5.11.x is the last Java 8-compatible line
