...
dependencies {
    ...
    optionalImplementation("software.amazon.awssdk:rds:2.44.12")
    optionalImplementation("software.amazon.awssdk:auth:2.44.12") // Required for IAM (light implementation)
    optionalImplementation("software.amazon.awssdk:http-client-spi:2.44.12") // Required for IAM (light implementation)
    optionalImplementation("software.amazon.awssdk:sts:2.44.12")
    optionalImplementation("software.amazon.awssdk:kms:2.44.12")
    optionalImplementation("software.amazon.awssdk:secretsmanager:2.44.12")
    ...
    federatedAuthBundleImplementation("software.amazon.awssdk:rds:2.44.12")
    federatedAuthBundleImplementation("software.amazon.awssdk:sts:2.44.12")
    ...
    testImplementation("software.amazon.awssdk:kms:2.44.12")
    testImplementation("software.amazon.awssdk:rds:2.44.12", )
    testImplementation("software.amazon.awssdk:auth:2.44.12") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:http-client-spi:2.44.12") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:ec2:2.44.12")
    testImplementation("software.amazon.awssdk:secretsmanager:2.44.12")
    testImplementation("software.amazon.awssdk:sts:2.44.12")
