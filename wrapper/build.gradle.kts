...
dependencies {
    ...
    compileOnly("software.amazon.awssdk:rds:2.25.53")
    ...
    testImplementation("software.amazon.awssdk:rds:2.25.53")
    testImplementation("software.amazon.awssdk:auth:2.25.46") // Required for IAM (light implementation)
