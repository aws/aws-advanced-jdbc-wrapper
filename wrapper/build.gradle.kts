...
dependencies {
    ...
    compileOnly("software.amazon.awssdk:auth:2.25.64") // Required for IAM (light implementation)
    ...
    testImplementation("software.amazon.awssdk:auth:2.25.64") // Required for IAM (light implementation)
