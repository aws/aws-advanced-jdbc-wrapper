...
dependencies {
    ...
    compileOnly("software.amazon.awssdk:rds:2.32.22")
    compileOnly("software.amazon.awssdk:auth:2.32.22") // Required for IAM (light implementation)
    compileOnly("software.amazon.awssdk:http-client-spi:2.32.22") // Required for IAM (light implementation)
    compileOnly("software.amazon.awssdk:sts:2.32.22")
    compileOnly("com.zaxxer:HikariCP:4.0.3") // Version 4.+ is compatible with Java 8
    compileOnly("com.mchange:c3p0:0.11.0")
    compileOnly("software.amazon.awssdk:secretsmanager:2.32.22")
    ...
    testImplementation("software.amazon.awssdk:rds:2.32.22")
    testImplementation("software.amazon.awssdk:auth:2.32.22") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:http-client-spi:2.32.22") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:ec2:2.32.22")
    testImplementation("software.amazon.awssdk:secretsmanager:2.32.22")
    testImplementation("software.amazon.awssdk:sts:2.32.22")
