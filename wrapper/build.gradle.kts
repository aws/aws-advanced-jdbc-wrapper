...
dependencies {
    ...
    optionalImplementation("software.amazon.awssdk:rds:2.42.38")
    optionalImplementation("software.amazon.awssdk:auth:2.42.38") // Required for IAM (light implementation)
    optionalImplementation("software.amazon.awssdk:http-client-spi:2.42.38") // Required for IAM (light implementation)
    optionalImplementation("software.amazon.awssdk:sts:2.42.38")
    optionalImplementation("software.amazon.awssdk:kms:2.42.38")
    optionalImplementation("software.amazon.awssdk:secretsmanager:2.42.38")
    ...
    optionalImplementation("com.github.jsqlparser:jsqlparser:5.3")
    ...
    federatedAuthBundleImplementation("software.amazon.awssdk:rds:2.42.38")
    federatedAuthBundleImplementation("software.amazon.awssdk:sts:2.42.38")
    ...
    testImplementation("software.amazon.awssdk:kms:2.42.38")
    testImplementation("software.amazon.awssdk:rds:2.42.38", )
    testImplementation("software.amazon.awssdk:auth:2.42.38") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:http-client-spi:2.42.38") // Required for IAM (light implementation)
