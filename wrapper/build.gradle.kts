...
dependencies {
    ...
    compileOnly("software.amazon.awssdk:auth:2.25.22") // Required for IAM (light implementation)
    ...
    testImplementation("software.amazon.awssdk:auth:2.25.22") // Required for IAM (light implementation)
