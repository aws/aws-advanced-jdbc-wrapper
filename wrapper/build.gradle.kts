...
dependencies {
    ...
    testImplementation("org.springframework.boot:spring-boot-starter-jdbc:3.1.3") // 3.1.3 is the last version compatible with Java 8
    ...
    testImplementation("software.amazon.awssdk:secretsmanager:2.20.136")
