...
dependencies {
    ...
    compileOnly("software.amazon.awssdk:http-client-spi:2.29.50") // Required for IAM (light implementation)
    ...
    testImplementation("software.amazon.awssdk:http-client-spi:2.29.50") // Required for IAM (light implementation)
