...
dependencies {
    ...
    optionalImplementation("software.amazon.awssdk:rds:2.42.24")
    optionalImplementation("software.amazon.awssdk:auth:2.42.24") // Required for IAM (light implementation)
    ...
    federatedAuthBundleImplementation("software.amazon.awssdk:rds:2.42.24")
    federatedAuthBundleImplementation("software.amazon.awssdk:sts:2.42.24")
    ...
    testImplementation("software.amazon.awssdk:rds:2.42.24", )
    testImplementation("software.amazon.awssdk:auth:2.42.24") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:http-client-spi:2.42.24") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:ec2:2.42.24")
    testImplementation("software.amazon.awssdk:secretsmanager:2.42.24")
    testImplementation("software.amazon.awssdk:sts:2.42.24")
