...
dependencies {
    ...
    compileOnly("software.amazon.awssdk:secretsmanager:2.26.7")
    ...
    compileOnly("io.opentelemetry:opentelemetry-sdk:1.39.0")
    compileOnly("io.opentelemetry:opentelemetry-sdk-metrics:1.39.0")
