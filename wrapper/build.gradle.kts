...
dependencies {
    ...
    optionalImplementation("software.amazon.awssdk:sts:2.41.20")
    optionalImplementation("software.amazon.awssdk:secretsmanager:2.41.20")
    ...
    federatedAuthBundleImplementation("software.amazon.awssdk:rds:2.41.20")
    federatedAuthBundleImplementation("software.amazon.awssdk:sts:2.41.20")
    federatedAuthBundleImplementation("org.jsoup:jsoup:1.21.1")

    testImplementation("org.checkerframework:checker-qual:3.49.5")
    testImplementation("org.junit.platform:junit-platform-commons:6.0.2")
    ...
    testImplementation("software.amazon.awssdk:ec2:2.41.20")
    testImplementation("software.amazon.awssdk:secretsmanager:2.41.20")
    testImplementation("software.amazon.awssdk:sts:2.41.20")
