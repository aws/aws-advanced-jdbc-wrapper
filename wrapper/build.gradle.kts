...
dependencies {
    ...
    optionalImplementation("software.amazon.awssdk:rds:2.41.29")
    optionalImplementation("software.amazon.awssdk:auth:2.41.29") // Required for IAM (light implementation)
    optionalImplementation("software.amazon.awssdk:http-client-spi:2.41.29") // Required for IAM (light implementation)
    optionalImplementation("software.amazon.awssdk:sts:2.41.29")
    optionalImplementation("software.amazon.awssdk:secretsmanager:2.41.29")
    ...
    federatedAuthBundleImplementation("software.amazon.awssdk:rds:2.41.29")
    federatedAuthBundleImplementation("software.amazon.awssdk:sts:2.41.29")
    ...
    testImplementation("software.amazon.awssdk:rds:2.41.29", )
    testImplementation("software.amazon.awssdk:auth:2.41.29") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:http-client-spi:2.41.29") // Required for IAM (light implementation)
    testImplementation("software.amazon.awssdk:ec2:2.41.29")
    testImplementation("software.amazon.awssdk:secretsmanager:2.41.29")
    testImplementation("software.amazon.awssdk:sts:2.41.29")
