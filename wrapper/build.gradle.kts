...
dependencies {
    ...
    compileOnly("software.amazon.awssdk:auth:2.26.17") // Required for IAM (light implementation)
    ...
    compileOnly("org.osgi:org.osgi.core:6.0.0")
    compileOnly("com.amazonaws:aws-xray-recorder-sdk-core:2.17.0")
    ...
    testImplementation("software.amazon.awssdk:auth:2.26.17") // Required for IAM (light implementation)
    ...
    testImplementation("com.amazonaws:aws-xray-recorder-sdk-core:2.17.0")
    testImplementation("io.opentelemetry:opentelemetry-api:1.40.0")
