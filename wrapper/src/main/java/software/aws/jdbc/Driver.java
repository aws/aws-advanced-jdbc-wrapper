...
public class Driver implements java.sql.Driver {
  ...
  private static final Logger PARENT_LOGGER = Logger.getLogger("software.aws.jdbc");
  private static final Logger LOGGER = Logger.getLogger("software.aws.jdbc.Driver");
