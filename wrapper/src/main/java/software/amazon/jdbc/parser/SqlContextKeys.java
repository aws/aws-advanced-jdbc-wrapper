...
public final class SqlContextKeys {
  ...
  /** Query type as a {@link QueryType} (SELECT, INSERT, UPDATE, DELETE, CREATE, DROP, UNKNOWN). */
  ...
  /** Routing hint from SQL comment as a {@link RoutingHint}, or null if not specified.
