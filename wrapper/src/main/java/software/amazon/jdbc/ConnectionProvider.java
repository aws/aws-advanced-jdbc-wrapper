...
public interface ConnectionProvider {
   ...
   *
   * @param databaseDialect Dialect for the database we are connecting to
   ...
   */
  Connection connect(
      @NonNull DatabaseDialect databaseDialect, @NonNull HostSpec hostSpec, @NonNull Properties props)
      throws SQLException;
