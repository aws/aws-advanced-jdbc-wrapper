...
public class MysqlHikariPooledConnectionProvider extends HikariPooledConnectionProvider {
  ...
  public MysqlHikariPooledConnectionProvider(HikariPoolConfigurator configurator) {
    super(configurator);
  }
