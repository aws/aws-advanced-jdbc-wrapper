...
/**
 * Exception thrown when metadata operations fail, such as loading encryption
 * configuration from database or cache operations.
...
public class MetadataException extends SQLException {
    ...
    /**
     * Constructs a MetadataException with the specified detail message, cause,
