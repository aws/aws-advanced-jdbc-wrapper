...
public class ElastiCacheIamTokenUtility implements IamTokenUtility {
  ...
  public String generateAuthenticationToken(
    ...
    // Format should be:
    // Regular: <cache-name>/?Action=connect&User=<username>&X-Amz-Security-Token=...
    //    &X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Date=...&X-Amz-SignedHeaders=host
    //    &X-Amz-Expires=870&X-Amz-Credential=...&X-Amz-Signature=...
    // Serverless: <cache-name>/?Action=connect&User=<username>&ResourceType=ServerlessCache
    //    &X-Amz-Security-Token=...&X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Date=...
    //    &X-Amz-SignedHeaders=host&X-Amz-Expires=870&X-Amz-Credential=...&X-Amz-Signature=...
