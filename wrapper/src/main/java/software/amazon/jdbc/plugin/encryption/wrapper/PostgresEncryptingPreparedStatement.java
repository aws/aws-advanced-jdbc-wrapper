 ...
 */
public class PostgresEncryptingPreparedStatement implements PreparedStatement {

  private static final Logger LOGGER =
      Logger.getLogger(PostgresEncryptingPreparedStatement.class.getName());
  ...
  public PostgresEncryptingPreparedStatement(
      ...
      String sql) {
    LOGGER.finest(() -> String.format("PostgresEncryptingPreparedStatement created for SQL: %s", sql));
  ...
  public void setString(int parameterIndex, String x) throws SQLException {
    ...
    if (encryptedValue instanceof byte[]) {
      ...
      LOGGER.finest(
          () ->
              String.format(
                  "PostgresEncryptingPreparedStatement.setString: param=%d, encryptedLength=%d",
                  parameterIndex,
                  encBytes.length));
