...
/**
 * A Connection wrapper that provides transparent encryption/decryption functionality
 * by wrapping PreparedStatements and ResultSets with encryption-aware implementations.
 */
public class EncryptingConnection implements Connection {
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        ...
        return encryptionPlugin.wrapPreparedStatement(statement, sql);
    }
    ...
    public Statement createStatement() throws SQLException {
        ...
        return new EncryptingStatement(statement, encryptionPlugin);
    }
    ...
    // All other Connection methods delegate directly to the wrapped connection
