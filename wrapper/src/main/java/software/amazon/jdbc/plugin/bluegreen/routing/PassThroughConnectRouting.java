...
public class PassThroughConnectRouting extends BaseConnectRouting {
  ...
  private static final Logger LOGGER = Logger.getLogger(PassThroughConnectRouting.class.getName());

  public PassThroughConnectRouting(@Nullable String hostAndPort, @Nullable BlueGreenRole role) {
