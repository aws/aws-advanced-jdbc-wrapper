 ...
 * These parameters can be used to create independent connections to the same database.
 */
public class ConnectionParameters {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(jdbcUrl, username, password, connectionProperties, 
                          driverClassName, catalog, schema);
    }
