...
public class PostgresHikariPooledConnectionProvider extends HikariPooledConnectionProvider {
  ...
  public PostgresHikariPooledConnectionProvider(HikariPoolConfigurator configurator) {
    super(configurator);
  }
