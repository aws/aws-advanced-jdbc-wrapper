  ...
  public static <T> T executeWithPlugins(
    ...
    try {
      ...
      if (jdbcMethod.shouldLockConnection && jdbcMethod.checkBoundedConnection) {
        ...
        if (conn != null && !connectionWrapper.getServicesContainer().getPluginService()
            .getTargetDriverDialect().isSameConnection(conn, connectionWrapper.getCurrentConnection())) {
