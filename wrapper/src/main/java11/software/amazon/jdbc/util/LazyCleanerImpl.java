  ...
  private static class CleanableWrapper implements Cleanable {
    ...
    public void clean() throws Exception {
      if (!this.cleaned) {
        ...
        // It's important to call it before this.cleanable.clean() (next line).
        this.action.onClean(false);

        // Indirectly calls action clean with registered runnable. However, the action has already
        // been cleaned above.
