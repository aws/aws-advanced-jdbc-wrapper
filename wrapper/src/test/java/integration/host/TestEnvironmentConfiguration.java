...
public class TestEnvironmentConfiguration {
  ...
  public boolean noFailover = Boolean.parseBoolean(System.getProperty("test-no-failover", "false"));
  ...
  public boolean noOpenJdk8 = Boolean.parseBoolean(System.getProperty("test-no-openjdk8", "false"));
  ...
  public boolean noBlueGreen = Boolean.parseBoolean(System.getProperty("test-no-bg", "true"));
  ...
  public String rdsDbName =
      System.getenv("RDS_DB_NAME"); // "cluster-mysql", "instance-name", "cluster-multi-az-name"
  public String rdsDbDomain = System.getenv("RDS_DB_DOMAIN"); // "XYZ.us-west-2.rds.amazonaws.com"

  public String rdsEndpoint = System.getenv("RDS_ENDPOINT"); // "https://rds-int.amazon.com"

  // Expected values: "latest", "default", or engine version, for example, "15.4"
  // If left as empty, will use default version
  public String mysqlVersion = System.getenv("MYSQL_VERSION");
  public String pgVersion = System.getenv("PG_VERSION");
