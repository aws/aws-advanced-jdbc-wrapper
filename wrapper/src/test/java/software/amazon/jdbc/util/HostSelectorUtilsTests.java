...
public class HostSelectorUtilsTests {
  ...
  void testSetHostWeightPairsProperty() {
    ...
    HostSelectorUtils.setHostWeightPairsProperty(
        RoundRobinHostSelector.ROUND_ROBIN_HOST_WEIGHT_PAIRS, properties, hosts);

    final String actualPropertyValue =
        properties.getProperty(RoundRobinHostSelector.ROUND_ROBIN_HOST_WEIGHT_PAIRS.name);
