...
class SqlAnalyzerTest {
  ...
  public void testSelectWithColumns() {
    SQLAnalyzer.QueryAnalysis result = SQLAnalyzer.analyze("SELECT name, age FROM users");
  ...
  public void testSelectStar() {
    SQLAnalyzer.QueryAnalysis result = SQLAnalyzer.analyze("SELECT * FROM products");
    assertEquals("SELECT", result.queryType);
  ...
  public void testSelectWithoutTable() {
    SQLAnalyzer.QueryAnalysis result = SQLAnalyzer.analyze("SELECT 1, 'test'");
    assertEquals("SELECT", result.queryType);
  }

  @Test
  public void testInvalidSQL() {
    SQLAnalyzer.QueryAnalysis result = SQLAnalyzer.analyze("INVALID SQL");
  ...
  public void testCreateTable() {
    SQLAnalyzer.QueryAnalysis result =
        SQLAnalyzer.analyze("CREATE TABLE test (id INT, name VARCHAR(50))");
  ...
  public void testInsertWithoutPlaceholders() {
    SQLAnalyzer.QueryAnalysis result =
        SQLAnalyzer.analyze("INSERT INTO users (name, email) VALUES ('John', 'john@example.com')");
  ...
  public void testInsertWithPlaceholders() {
    SQLAnalyzer.QueryAnalysis result =
        SQLAnalyzer.analyze("INSERT INTO users (name, email, age) VALUES (?, ?, ?)");
    assertEquals("INSERT", result.queryType);
    assertTrue(result.tables.contains("users"));
    assertEquals(3, result.columns.size());
    assertTrue(
  ...
  public void testUpdateWithoutPlaceholders() {
    SQLAnalyzer.QueryAnalysis result =
        SQLAnalyzer.analyze("UPDATE users SET name = 'Jane', email = 'jane@example.com' WHERE id = 1");
  ...
  public void testUpdateWithPlaceholders() {
    SQLAnalyzer.QueryAnalysis result =
        SQLAnalyzer.analyze("UPDATE users SET name = ?, email = ? WHERE id = ?");
    assertEquals("UPDATE", result.queryType);
    assertTrue(result.tables.contains("users"));
    assertEquals(2, result.columns.size()); // name, email (SET clause only)
    assertTrue(
  ...
  public void testDelete() {
    SQLAnalyzer.QueryAnalysis result = SQLAnalyzer.analyze("DELETE FROM users WHERE id = 1");
  ...
  public void testDrop() {
    SQLAnalyzer.QueryAnalysis result = SQLAnalyzer.analyze("DROP TABLE users");
  ...
  public void testCrossJoin() {
    SQLAnalyzer.QueryAnalysis result = SQLAnalyzer.analyze("SELECT * FROM users CROSS JOIN products");
    assertEquals("SELECT", result.queryType);
    assertEquals(2, result.tables.size());
    assertTrue(result.tables.contains("users"));
    assertTrue(result.tables.contains("products"));
  ...
  public void testSelectWithCast() {
    SQLAnalyzer.QueryAnalysis result =
        SQLAnalyzer.analyze("SELECT CAST(price AS INTEGER) FROM products");
    assertEquals("SELECT", result.queryType);
    assertTrue(result.tables.contains("products"));
  }
  ...
  public void testUpdateMultipleColumns() {
    SQLAnalyzer.QueryAnalysis result =
        SQLAnalyzer.analyze("UPDATE users SET name = ?, email = ?, age = ? WHERE id = ?");
    assertEquals("UPDATE", result.queryType);
    assertTrue(result.tables.contains("users"));
    assertEquals(3, result.columns.size());
    assertTrue(
  ...
  public void testInsertMultipleRows() {
    SQLAnalyzer.QueryAnalysis result =
        SQLAnalyzer.analyze("INSERT INTO users (name, email) VALUES ('Alice', 'alice@example.com')");
    assertEquals("INSERT", result.queryType);
    assertTrue(result.tables.contains("users"));
    assertEquals(2, result.columns.size());
  }
  ...
  public void testSelectWithOrderBy() {
    SQLAnalyzer.QueryAnalysis result =
        SQLAnalyzer.analyze("SELECT name, age FROM users ORDER BY age DESC NULLS LAST");
    assertEquals("SELECT", result.queryType);
    assertTrue(result.tables.contains("users"));
    assertEquals(2, result.columns.size());
  }
  ...
  public void testSelectWithGroupBy() {
    SQLAnalyzer.QueryAnalysis result =
        SQLAnalyzer.analyze("SELECT department, COUNT(*) FROM employees GROUP BY department");
    assertEquals("SELECT", result.queryType);
  ...
  public void testSelectWithLimitOffset() {
    SQLAnalyzer.QueryAnalysis result =
        SQLAnalyzer.analyze("SELECT * FROM users ORDER BY id LIMIT 10 OFFSET 20");
    assertEquals("SELECT", result.queryType);
    assertTrue(result.tables.contains("users"));
  }
  ...
  public void testDeleteWithWhere() {
    SQLAnalyzer.QueryAnalysis result = SQLAnalyzer.analyze("DELETE FROM users WHERE age < 18");
    assertEquals("DELETE", result.queryType);
    assertTrue(result.tables.contains("users"));
  }
  ...
  public void testSchemaQualifiedTable() {
    SQLAnalyzer.QueryAnalysis result = SQLAnalyzer.analyze("SELECT * FROM public.users");
    assertEquals("SELECT", result.queryType);
    assertTrue(result.tables.contains("users"));
  }
  ...
  public void testInsertWithSchemaQualifiedTable() {
    SQLAnalyzer.QueryAnalysis result =
        SQLAnalyzer.analyze("INSERT INTO myschema.users (name, ssn) VALUES (?, ?)");
    assertEquals("INSERT", result.queryType);
    assertTrue(result.tables.contains("users"));
    assertEquals(2, result.columns.size());
    assertTrue(
  ...
  public void testUpdateWithSchemaQualifiedTable() {
    SQLAnalyzer.QueryAnalysis result =
        SQLAnalyzer.analyze("UPDATE app_data.customers SET email = ? WHERE id = ?");
    assertEquals("UPDATE", result.queryType);
  ...
  public void testSelectWithSchemaQualifiedTableAndColumns() {
    SQLAnalyzer.QueryAnalysis result =
        SQLAnalyzer.analyze("SELECT u.name, u.ssn FROM hr.users u WHERE u.id = ?");
    assertEquals("SELECT", result.queryType);
    assertTrue(result.tables.contains("users"));
    assertEquals(2, result.columns.size());
    assertTrue(
  ...
  public void testDeleteWithSchemaQualifiedTable() {
    SQLAnalyzer.QueryAnalysis result =
        SQLAnalyzer.analyze("DELETE FROM archive.old_records WHERE created_at < ?");
    assertEquals("DELETE", result.queryType);
